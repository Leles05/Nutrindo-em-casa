...
export default function DashboardInicio() {
  ...
  // Aqui no futuro puxaremos o nome da mãe do Banco de Dados
  const nomeMae = "Maria"; 

  // Lógica para o Bom dia / Boa tarde / Boa noite
  useEffect(() => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animation-fade-in">
      ...
      {/* Cabeçalho com Saudação Emocional */}
      <header className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-extrabold text-[#4C6C54]">
            {saudacao}, {nomeMae}! 👋
          </h1>
          <p className="text-slate-500 mt-1">Aqui está o resumo da jornada do seu pequeno hoje.</p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="col-span-1 lg:col-span-2 space-y-8">
          ...
          {/* Área do Calendário Gigante (Placeholder por enquanto) */}
          <section className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 min-h-[400px]">
        ...
        {/* Coluna da Direita (Espaço reservado para o Diário/Mapa) - Ocupa 1/3 */}
        <div className="col-span-1 space-y-8">
          
          <section className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 h-full min-h-[600px]">
            <h3 className="text-xl font-bold text-slate-800 mb-6">Diário Alimentar</h3>
            <div className="flex items-center justify-center h-full border-2 border-dashed border-slate-200 rounded-2xl bg-[#F0EAE1]/30">
