    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F0EAE1] text-slate-800 font-sans p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-md border border-slate-100 p-8 sm:p-10">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <button className="flex items-center justify-center gap-2 h-12 rounded-2xl bg-slate-50 border border-slate-200 hover:bg-slate-100 transition-colors text-sm font-semibold text-slate-600">
          ...
          <button className="flex items-center justify-center gap-2 h-12 rounded-2xl bg-slate-50 border border-slate-200 hover:bg-slate-100 transition-colors text-sm font-semibold text-slate-600">
            {/* Ícone Oficial do Facebook em SVG */}
            <svg viewBox="0 0 24 24" width="18" height="18" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="relative flex items-center py-4 mb-4">
          ...
          <span className="shrink-0 px-4 text-sm text-slate-400 font-medium">ou</span>
          <div className="flex-grow border-t border-slate-100"></div>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-[#4C6C54] mb-1.5">Senha</label>
            <div className="relative">
              <input
                ...
                className="w-full h-12 px-4 pr-12 bg-slate-50 border border-slate-200 rounded-2xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#4C6C54]/50 focus:border-[#4C6C54] transition-all"
                required
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            className="w-full h-12 flex items-center justify-center bg-[#4C6C54] hover:bg-[#3a5340] text-white font-semibold rounded-2xl transition-colors shadow-sm mt-6"
          >
            Entrar
          </button>
        </form>
